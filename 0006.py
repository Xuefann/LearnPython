...
"""
	你有一个目录，放了你一个月的日记，都是 txt，为了避免分词的问题，假设内容都是英文，请统计出你认为每篇日
记最重要的词。
"""
import os
import re
			...
			with open(filePath) as f:
				...
				for word in words:
					...
					if word in wordDict:
						...
						wordDict[word] = 1
			ansList = sorted(wordDieszct.items(), key = lambda t:t[1], reverse = True)
			print('file: %s->the most word:%s' %(file,ansList[1]))

if __name__ == '__main__':
	findWord(r'C:\Users\ASUS\Desktop\0006')